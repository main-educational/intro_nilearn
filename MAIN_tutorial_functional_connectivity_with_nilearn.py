...
# # An introduction to functional connectiviy with [`nilearn`](http://nilearn.github.io)
...
#
# Today we will learn about the most common type of neuroimaging data, functional magnetic resonance imaging (fMRI) data.
#
#
# <!-- Add explaination of BOLD roughly here -->
#
# Neuroimaging data contains a lot of noise that's not blood-oxygen-level dependent (BOLD), such as head motion.
...
# +
# TODO: use nilearn dev branch as dependnecy to show case load_confounds
